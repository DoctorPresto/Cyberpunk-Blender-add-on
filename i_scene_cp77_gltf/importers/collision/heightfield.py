...
def create_geom_from_heightfield(heightfieldGeometry):
    ...
    # === Create mesh ===
    mesh = track_created_datablock("meshes", bpy.data.meshes.new("HeightfieldMesh"))
    mesh.from_pydata(verts, [], faces)
    mesh.update()

    # === Create object ===
    obj = track_created_datablock("objects", bpy.data.objects.new("Heightfield", mesh))
    ...
    for m_id in unique_mats:
        mat = track_created_datablock("materials", bpy.data.materials.new(name=f"Mat_{m_id}"))
