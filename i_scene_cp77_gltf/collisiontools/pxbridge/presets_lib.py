...
_RAW_PRESETS = {
    ...
    "Moving Platform": (
        ["Dynamic", "VehicleBlocker", "TankBlocker", "PlayerBlocker"],
        ["Player", "AI", "Dynamic", "Vehicle", "Tank", "Destructible", "Particle", "Ragdoll", "Ragdoll Inner",
         "Debris"],
        ["Visibility", "Dynamic", "Shooting", "PhotoModeCamera", "NPCBlocker", "VehicleBlocker", "TankBlocker",
         "PlayerBlocker"]
        ),
    "Water": (
        [],
    ...
    "Device transparent": (
        ...
        ["Dynamic", "Collider", "Interaction", "PhotoModeCamera", "PlayerBlocker", "VehicleBlocker", "TankBlocker",
         "Visibility"]
        ),
    "Device solid visible": (
        ["Dynamic", "PlayerBlocker", "VehicleBlocker", "TankBlocker"],
        ["Player", "AI", "Dynamic", "Destructible", "Ragdoll", "Ragdoll Inner", "Debris", "PlayerBlocker"],
        ["Dynamic", "Collider", "VehicleBlocker", "TankBlocker", "Visibility", "Interaction", "PhotoModeCamera",
         "PlayerBlocker", "NPCBlocker"]
        ),
    "Vehicle Device": (
        ["PlayerBlocker"],
    ...
    "World Static": (
        ...
        ["Static", "Visibility", "Shooting", "VehicleBlocker", "PhotoModeCamera", "VehicleBlocker", "TankBlocker",
         "PlayerBlocker"]
        ),
    ...
    "Spider Tank": (
        ...
        ["Player", "Vehicle", "Tank", "PlayerBlocker", "VehicleBlocker", "TankBlocker", "Destructible", "Terrain",
         "Debris", "Ragdoll", "Ragdoll Inner"],
