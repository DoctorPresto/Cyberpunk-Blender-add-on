    ...
    def create(self, Data, Mat):
        ...
        if "DiffuseTexture" in Data:
            ...
            dImgNode = create_node(
                CurMat.nodes, "ShaderNodeTexImage", (-1200, 400), label="DiffuseTexture", image=dcolImg
                )
        ...
        if "RoughnessTexture" in Data:
            ...
            rImgNode = create_node(
                CurMat.nodes, "ShaderNodeTexImage", (-1200, -100), label="RoughnessTexture", image=rImg
                )
        ...
        if "MetalnessTexture" in Data:
            ...
            mImgNode = create_node(
                CurMat.nodes, "ShaderNodeTexImage", (-1200, 50), label="MetalnessTexture", image=mImg
                )
