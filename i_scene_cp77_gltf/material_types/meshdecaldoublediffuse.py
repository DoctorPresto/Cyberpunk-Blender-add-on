    ...
    def create(self, Data, Mat):
        ...
        if "DiffuseTexture" in Data:
            dImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["DiffuseTexture"], -1200, 500, 'DiffuseTexture', self.image_format
                )
        ...
        if "NormalTexture" in Data:
            nMap = CreateShaderNodeNormalMap(
                CurMat, self.BasePath + Data["NormalTexture"], -800, -350, 'NormalTexture', self.image_format
                )
        ...
        if "RoughnessTexture" in Data:
            rImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["RoughnessTexture"], -1200, 0, 'RoughnessTexture', self.image_format, True
                )
        ...
        if "MetalnessTexture" in Data:
            mImgNode = CreateShaderNodeTexImage(
                CurMat, self.BasePath + Data["MetalnessTexture"], -1200, 200, 'MetalnessTexture', self.image_format,
                True
                )
