...
class windowParallaxIntProx:
    ...
    def create(self, Data, Mat):
        ...
        WhiteNoiseTexture = create_node(
            CurMat.nodes, "ShaderNodeTexWhiteNoise", (-1077.558349609375, 946.2904052734375),
        ...
        Math002 = create_node(
            CurMat.nodes, "ShaderNodeMath", (-891.7330322265625, 936.3861694335938), operation='MULTIPLY',
            label="Math.002"
            )
        ...
        if 'WindowTexture' in Data:
            ...
            if 'Normal' in Data:
                wNormImg = imageFromRelPath(
                        Data["Normal"], self.image_format, DepotPath=self.BasePath, ProjPath=self.ProjPath,
                        isNormal=True
                        )
