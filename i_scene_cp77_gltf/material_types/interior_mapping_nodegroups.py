...
def andrew_willmotts_plane_interior_mapping_node_group():
    if 'CP77_AW_Plane_Interior_Mapping' in bpy.data.node_groups.keys():
        ...
        AR_div = create_node(
            andrew_willmotts_interior_mapping.nodes, "ShaderNodeMath", (96.85089111328125, 100.), operation='DIVIDE'
            )
        ...
        MultAdd = create_node(
            andrew_willmotts_interior_mapping.nodes, "ShaderNodeMath", (10., 10), operation='MULTIPLY_ADD'
            )
