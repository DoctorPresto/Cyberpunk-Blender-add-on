...
class JALIAnimationPipeline:
    ...
    def generate_animation(
        ...
        unique = set(
                e.phoneme for e in phoneme_events
        ...
        print(
            f"[JALI] Complete — {non_zero}/{num_tracks} active tracks, "
...
def keyframe_tracks(
    ...
    from .tracks import _bulk_set_keyframes, add_track_action_group
    ...
    fcurves = get_action_fcurves(action, armature_obj, create=True)
