"""Self-contained Blender 5 animation and read-rig compatibility helpers.

This module intentionally has no dependency on the add-on root or main package,
so it is safe to import while i_scene_cp77_gltf is still initializing.
"""
...
def merged_rig_bone_name(name: str) -> str:
    """Map authored MetaRig plug names to merged slot names."""
    value = str(name)
