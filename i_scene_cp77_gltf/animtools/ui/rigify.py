...
from ...animation.rigify.mapping import DIRECTION_FORWARD, get_rigify_coll_prop
...
def _draw_direction_toggle(layout, source, rig, current_direction: str) -> None:
    ...
    row.scale_y = 1.15
    forward = current_direction == DIRECTION_FORWARD
    op = row.operator(
...
def draw_rigify_controls(layout, context) -> None:
    ...
    direction = get_constraint_direction(source)
