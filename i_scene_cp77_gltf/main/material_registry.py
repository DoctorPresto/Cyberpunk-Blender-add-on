...
from ..material_types.global_water_patch import GlobalWaterPatch
...
def _factory_bipm(cls):
    return lambda b, raw: cls(b.BasePath, b.image_format, b.ProjPath, b.MeshPath)
...
REGISTRY.register([
    ...
    factory=_factory_bip(DeviceDiode),
    preserve_render_method=True,
))
